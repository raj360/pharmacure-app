...
class PhoneVerificationActivity : AppCompatActivity(),DIAware,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        contextView = findViewById(R.id.constraintLayoutVerifications)
        mAuth = FirebaseAuth.getInstance()

        intent.apply {
            liveFullName.value = getStringExtra(FULL_NAME)
            displayName.text = getStringExtra(FULL_NAME)
