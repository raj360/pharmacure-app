...
import com.pharmacure.online_pharmacy_app.providers.network.api.IDrugApi
...
class DrugRemoteDataSource(private var drugApi: IPharmacureApi) : IDrugRemoteDataSource {
